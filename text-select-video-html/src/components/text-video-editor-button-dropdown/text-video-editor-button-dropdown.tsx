...
@Component({
    tag: 'text-video-editor-button-dropdown',
    styleUrl: 'text-video-editor-button-dropdown.scss',
    shadow: true
})
export class TextVideoEditor {
    ...
    render() {
        return (
            <span class="text-video-editor-dropdown">
                <span class="text-video-editor-dropdown-selected">
                    <input
                        type="text"
                        value={this.selected}
                ...
                {this.toggledDropdown && (
                    <span class="text-video-editor-dropdown-list">
                        <ul>
